        ...
        >
          <div className="flex-1 lg:mr-12 w-full">
            ...
            <motion.div variants={itemVariants} className="hidden lg:block">
              <h1
                className={`text-4xl md:text-5xl font-bold mb-4 ${theme === "retro" ? "font-mono text-3xl md:text-4xl" : "font-sans"}`}
              >
                Hey! I&apos;m{" "}
            ...
            <motion.div variants={itemVariants}>
              ...
              >
                I&apos;m a passionate developer who loves turning ideas into intuitive and impactful digital experiences. With a keen eye for design and a problem-solving mindset, I craft seamless, user-friendly interfaces that blend aesthetics with functionality.
              </p>
            </motion.div>
            ...
            <motion.div variants={itemVariants}>
              ...
              >
                Beyond coding, I enjoy exploring new technologies, sharing knowledge, and collaborating on projects that make a difference. Whether it&apos;s building sleek web applications or mentoring aspiring developers, I believe in creating meaningful solutions that leave a lasting impact.
              </p>
            </motion.div>
